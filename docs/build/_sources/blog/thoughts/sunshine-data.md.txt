...
> March 30, 2020
> 
> This blog post provides a summary of the `sunshine` data collection, and sample code for querying the data.
---
...
![basic visualization](sunshine-data/sunshine-plot-1.png)
...
![improved visualization](sunshine-data/sunshine-plot-2.png)
